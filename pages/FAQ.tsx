          ...
          <section className="mx-4 py-[110px] md:mx-[105px] md:py-[100px] lg:mt-[30px]">
            ...
            <motion.div 
             ...
             >
                ...
                <p className="w-full text-[#160F29] mb-[40px] mt-[40px] md:mb-[40px] md:mt-[25px] lg:mb-[50px] lg:mt-[-50px] font-thin text-[18px] md:text-[18px] lg:text-[30px]">Click on our most frequently asked questions below to learn more about Creative Forge{"'"}s processes and procedures.</p>
                                ...
                                <>
                                    ...
                                    <AccordionButton>
                                        ...
                                        <h3 className="flex items-center mb-4 text-[18px] lg:text-[35px] font-medium text-gray-900">
                                            <svg className="flex-shrink-0 mr-2 w-5 h-5 text-[#56AEFF]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
