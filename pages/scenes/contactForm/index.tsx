    ...
    <div id="Contact" className='bg-slate-50 h-full w-full'>
        <section className=''>
            <div className="py-8 lg:py-16 px-6 mx-auto max-w-screen-md">
                ...
                <form action="https://formsubmit.co/cristian.v0223@gmail.com" method="POST" className="space-y-8 md:mb-[50px]">
                    <div>
                        <label className="block mb-2 text-sm font-thin md:text-[16px] lg:text-[22px] text-gray-900">Email</label>
                        <input name="name" type="email" id="email" className="shadow-sm bg-white text-gray-900 text-sm md:text-[16px] lg:text-[24px] rounded-lg focus:ring-primary-500 block w-full p-2.5 md:p-3 placeholder-gray-400 focus:border-primary-500 shadow-sm-light lg:p-6" placeholder="name@creativeforge.com" required />
                    </div>
                    <div>
                        <label  className="block mb-2 text-sm font-thin md:text-[16px] lg:text-[22px] text-gray-900">Subject</label>
                        <input name="subject" type="text" id="subject" className="block p-3 w-full text-sm text-gray-900 md:text-[16px] md:p-3 bg-white rounded-lg border shadow-sm focus:ring-primary-500 focus:border-primary-500 border-slate-100 placeholder-gray-400 shadow-sm-light lg:text-[24px] lg:p-6" placeholder="Let us know how we can help you" required />
                    </div>
