      ...
      <Layout setSelectedPage={setSelectedPage}>
        ...
        <article className="w-full mx-auto md:w-5/6 lg:w-5/6 px-6 py-36 md:mt-[-50px]">
          ...
          <div className="dark:text-gray-100">
            <p className="font-bold text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">1. Introduction</p>
            ...
            <p className="font-bold mt-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">2. Services</p>
            ...
            <p className="font-bold mt-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">3. Fees</p>
            ...
            <p className="font-bold mt-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">4. Payment</p>
            ...
            <p className="font-bold mt-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">5. Intellectual Property Rights</p>
            ...
            <p className="font-bold mt-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">6. Confidentiality</p>
            ...
            <p className="font-bold mt-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">7. Termination</p>
            ...
            <p className="font-bold mt-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">8. Limitation of Liability</p>
            ...
            <p className="font-bold my-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">9 Governing Law & Jurisdiction</p>
            <p className="font-thin my-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">This agreement shall be governed by English law and both parties hereby submit themselves exclusively to the jurisdiction of English courts.</p>
            <p className="font-bold my-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">10 Entire Agreement</p>
            <p className="font-thin my-10 text-[18px] md:text-[21px] lg:text-[28px] lg:mt-[80px]">This document constitutes the entire agreement between us and supersedes all prior agreements whether written or oral relating thereto . No amendment hereto shall be valid unless made in writing signed by both parties.</p>
